...
We then test each system on both mt03 and mt06, evaluting with MultEval \cite{clark2011better}.
...
the number of rules in the Hiero grammar \emph{filtered} for the 691-sentence test set is twice as large as the Bayesian grammar.
